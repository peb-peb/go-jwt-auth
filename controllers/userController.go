...
import (
	...
	"github.com/peb-peb/go-jwt-project/database"
	helper "github.com/peb-peb/go-jwt-project/helpers"
	"github.com/peb-peb/go-jwt-project/models"
...
func SignUp() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			log.Panic(err)
			c.JSON(http.StatusInternalServerError, gin.H{"error": "erroroccured while checking for the email"})
		}
	...
	return func(c *gin.Context) {
		...
		projectStage := bson.D{
			{"$project", bson.D{
				{"_id", 0},
				{"total_count", 1},
				{"user_items", bson.D{{"$silce", []interface{}{"$data", startIndex, recordPerPage}}}},
			}},
		}
